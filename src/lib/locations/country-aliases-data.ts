...
export const COUNTRY_ALIASES_DATA: Record<string, CountryDef> = {
  ...
  nikaragua: { code: "NI", name: "Nicaragua" },
  ...
  dominik: { code: "DO", name: "Dominican Republic" },
  dominikcumhuriyeti: { code: "DO", name: "Dominican Republic" },
  birlesikarapemirlikleri: { code: "AE", name: "United Arab Emirates" },
  arapemirlikleri: { code: "AE", name: "United Arab Emirates" },
  bae: { code: "AE", name: "United Arab Emirates" },
